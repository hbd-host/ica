...
x = setInterval(function() {
    ...
    function Letter(char, x, y) {
        ...
        // Mengganti kode untuk mengatur warna huruf dan kembang api menjadi ungu
        let hue = 270; // Menggunakan hue untuk ungu (270 adalah nilai untuk ungu pada HSL)
        let light = 60; // Mengatur lightness menjadi 60% agar warnanya tidak terlalu gelap
        let alp = 0.8; // Alpha channel (transparansi), bisa disesuaikan jika perlu

        this.color = 'hsl(' + hue + ', 80%, ' + light + '%)'; // Ubah warna karakter menjadi ungu
        this.lightAlphaColor = 'hsla(' + hue + ', 80%, ' + light + '%, ' + alp + ')'; // Ubah warna karakter untuk cahaya ungu dengan alpha
        this.lightColor = 'hsl(' + hue + ', 80%, ' + light + '%)'; // Ubah warna karakter untuk cahaya ungu
        this.alphaColor = 'hsla(' + hue + ', 80%, ' + light + '%, ' + alp + ')'; // Ubah warna karakter untuk alpha ungu
